...
pub fn render_about_me() -> impl IntoHtml {
    (
        ...
        p!(
            "Hi, I'm a software engineer powered by caffeine, Rust, and an unreasonable number of open terminal tabs. By day, I build robust, scalable systems that probably won't crash. By night, I write weird side projects in Rust just to see if I can—like a CLI that reminds me to touch grass."
        ),
        p!(
